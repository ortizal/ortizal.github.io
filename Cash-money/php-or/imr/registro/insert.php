...
$query =("INSERT INTO usuario(usr_id, usr_nombre, usr_apellido, usr_fechaNc, usr_email, usr_telefono, usr_usuario, usr_contraseña, usr_cedula) VALUES ('$id','$nombre','$apellido','$fechaNc','$email','$telefono','$usuario','$contraseña','$cedula')"); 
